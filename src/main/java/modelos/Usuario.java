...
public class Usuario {
    ...
    public Usuario(int id_usuario, String nombre_usuario, String email_usuario, String contraseña_usuario, int nivel_usuario, int puntos_usuario, int icono_perfil_id) {
